    ...
    for group in keyword_groups:
        ...
        for match in matches:
            ...
            extracted_sections.append({
                ...
                "start_keyword": start_keyword.strip(),
                "end_keyword": end_keyword.strip() if end_keyword else None,
...
# 테스트할 파일 경로
file_path = './txt/ea778cb2-f9d8-4249-9c8a-38397d9da747.txt'

# 텍스트 추출
sections = extract_text(file_path, keyword_groups)
